...
var experiment = {
	...
	start: function() {
		...
		experiment.data.push("subid, counter, trialtype, percentage, colorasked, searchtype, targetshape, targetcolor, targetword, distractorshape1, distractorshape2, distractorcolor, date, timestamp, rtsearch, rttest, targetpos, foilpos");
